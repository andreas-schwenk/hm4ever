...
\begin{metainfo}
  \name{
    \lang{de}{Ü02: Integral als Flächeninhalt}
    \lang{en}{exercise 2}
  }
  \begin{description} 
 ...
 https://creativecommons.org/licenses/by/4.0/legalcode 
  ...
  \end{description}
  \begin{components}
    \component{generic_image}{content/rwth/HM1/images/g_tkz_T107_Exercise02.meta.xml}{T107_Exercise02}
  \end{components}
  \begin{links}
...
\tab{
 ...
 \begin{incremental}[\initialsteps{1}]
    ...
    Die Berechnung kann wie in \link{link1}{Übung 1}
    geschehen:}
