...
\title{
\lang{de}{A05: L'Hospital}
\lang{en}{A05: L'Hôpital's rule}
}
\begin{block}[annotation]
	Im Ticket-System: \href{https://team.mumie.net/issues/24031}{Ticket 24031}
\end{block}
...
\begin{block}[annotation]
Kopie: hm4mint/T303_Approximationen/training 5
...
%######################################################QUESTION_START	
	...
	%+++++++++++++++++++TITLE++++++++++++++++++++++++++	
      ...
      \lang{en}{
	    	\text{Determine the following limit\\ $ \lim_{x\to \var{x0}} \frac{\var{f}}{\var{g}} = $\ansref.
            \\
            In particular, also consider why your method is justified.}
	    }
	%+++++++++++++++++++ANSWERS++++++++++++++++++++++++    
	    \begin{answer}
			\solution{sol}
	    ...
	    \end{answer}  
        \lang{de}{\explanation{Wenden Sie die Regel von de l'Hospital an.}}
        \lang{en}{\explanation{Apply L'Hôpital's rule.}}
	\end{question}
%######################################################QUESTION_END
...
%######################################################QUESTION_START	
	...
	%+++++++++++++++++++TITLE++++++++++++++++++++++++++	
     ...
     \lang{en}{
	    	\text{Determine the following limit\\ $ \lim_{x\to \var{x0}} \frac{\ln(\var{f})}{\var{g}} = $\ansref.
            \\
            Addendum: Also consider why your method is justified.}
	    }    
    %+++++++++++++++++++ANSWERS++++++++++++++++++++++++    
	    \begin{answer}
			\solution{sol}
