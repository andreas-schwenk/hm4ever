...
\end{metainfo}
\begin{content}
\lang{de}{\title{A02: Kettenregel}}
\lang{en}{\title{A02: Chain rule}}
\begin{block}[annotation]
	Im Ticket-System: \href{https://team.mumie.net/issues/24015}{Ticket 24015}
\end{block}
...
\begin{block}[annotation]
Kopie: hm4mint/T106_Differentialrechnung/training 5
...
\begin{question}
	...
	\begin{variables}
		...
		\function[calculate]{s}{2*m}
	    \function{p}{(a*x+b)^s}
        %\function{f_1}{s*(a*x+b)^(s-1)*a}
		\function{q}{cos(x^n)}
        %\function{f_2}{-sin(x^n)*n*x^(n-1)}
 		\derivative[normalize]{f_1}{p}{x}	    
