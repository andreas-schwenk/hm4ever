...
\begin{metainfo}
  \name{
    \lang{de}{Ü09: Hauptsatz der Integralrechnung}
    \lang{en}{exercise 9}
  }
  \begin{description} 
...
\lang{en}{Solution for a)}
 ...
 \begin{incremental}[\initialsteps{1}]
  ...
  \step
    \lang{de}{Wir bestimmen eine Stammfunktion und wenden dann den \ref[link1][Hauptsatz der Differential- und Integralrechnung]{thm:fundamental} an.}
...
\item
Berechnen Sie die folgenden Integrale. Zeichnen Sie die Integranden und machen Sie sich die Bedeutung des Ergebnisses Ihrer Rechnung grafisch klar.
\begin{enumerate}
\item $\int_2^4 \left(\frac{1}{2}x-1\right)dx$,
\item $\int_0^2 (-x+1)dx$,
\item $\int_{-1}^1 (y^2-1)dy$,
\item $\int_0^3 (z+1)(z-2) dz$,
