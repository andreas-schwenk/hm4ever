...
\begin{metainfo}
  \name{
    \lang{de}{Ü03: lineare Substitution}
    \lang{en}{exercise 3: linear substitution}
  }
  \begin{description} 
...
\end{metainfo}
\begin{content}
\title{\lang{de}{Ü03: lineare Substitution}
    \lang{en}{exercise 3: linear substitution}}
\begin{block}[annotation]
	Im Ticket-System: \href{https://team.mumie.net/issues/24048}{Ticket 24048}
\end{block}
\begin{block}[annotation]
	Kopie: hm4mint/T107_Integralrechnung/exercise 7
...
\lang{de}{Berechnen Sie die folgenden unbestimmten Integrale mit Hilfe einer linearen Substitution.}
