...
\begin{metainfo}
  \name{
    \lang{de}{Ü03: unbestimmte Integrale}
    \lang{en}{Exercise 3: indefinite integrals}
  }
  \begin{description} 
 ...
 https://creativecommons.org/licenses/by/4.0/legalcode 
  ...
  \end{components}
  \begin{links}
    %\link{generic_element}{content/TU9/omb_plus/calculus_of_integration/definition_fundamental_properties/exercises/g_exe_exercise_1.meta.xml}{link1}
  \end{links}
  \creategeneric
\end{metainfo}
\begin{content}
\title{\lang{de}{Ü03: unbestimmte Integrale}
    \lang{en}{Exercise 3: indefinite integrals}}
\begin{block}[annotation]
	Im Ticket-System: \href{https://team.mumie.net/issues/24042}{Ticket 24042}
\end{block}


\begin{block}[annotation]
Kopie: hm4mint/T107_Integralrechnung/exercise 4
...
%\item[b)]
  \lang{de}{Berechnen Sie die folgenden unbestimmten Integrale, wobei $a$ und $b$ konstante reelle
Zahlen sind. }
