...
\lang{en}{$x^2-1=0$ if $x=-1$ or $x=1$. So, $f''(x)=0$ for $x=1$ and $x=-1$.}
  ...
  \lang{en}{$x^2-1>0$ for $x\in (-\infty,-1)$ or $x\in (1,\infty)$. So, $f''(x)$ is positive in $(-\infty,-1)$ and $(1,\infty)$. Therefore, the graph of $f$ in $(-\infty,-1)$ and $(1,\infty)$ is convex.}
    
 \step \lang{de}{$x^2-1<0$ f\"{u}r $x\in (-1;1)$. Also ist $f''(x)$ auf $(-1;1)$ negativ, und der Graph von $f$ auf $(-1;1)$ rechtsgekr\"{u}mmt.}
 \lang{en}{$x^2-1<0$ for $x\in (-1,1)$. So, $f''(x)$ is negative in $(-1,1)$ and the graph of $f$ in $(-1,1)$ is concave.}
