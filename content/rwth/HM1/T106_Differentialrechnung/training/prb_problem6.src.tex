...
\end{block}
\begin{block}[annotation]
  Im Ticket-System: \href{http://team.mumie.net/issues/9471}{Ticket 9471}
\end{block}
...
\begin{question}
	\lang{de}{
		...
		\explanation{Da $e^{x^2} > 0$ ist $x_0 = 0$ die einzige Nullstelle von $f'(x)$. Im Punkt $x_0 = 0$ wechselt zudem $f'$ das Vorzeichen von negativ zu positiv.
        Somit muss in Null eine Minamlstelle von $f$ vorliegen. Damit kommt nur die rote Kurve in Frage.}
	}
	\lang{en}{
...
\begin{question}
	\lang{de}{
		...
		Mit Ihrer Maus k\"{o}nnen Sie den Ausschnitt und die Gr\"{o}{\ss}e des Bildes ver\"{a}ndern.}
		\explanation{Wie man sofort erkennt ist $x_0 = 0$ die einzige Nullstelle von $f'(x)$. Im Punkt $x_0 = 0$ wechselt zudem $f'$ das Vorzeichen von negativ zu positiv.
        Somit muss in Null eine Minamlstelle von $f$ vorliegen. Damit kommt nur die rote Kurve in Frage.}
	}
	\lang{en}{
...
\begin{question}
	\lang{de}{
		...
		Mit Ihrer Maus k\"{o}nnen Sie den Ausschnitt und die Gr\"{o}{\ss}e des Bildes ver\"{a}ndern.}
		\explanation{Es ist stets $f'(x) > 0$. Folglich ist $f$ streng monoton wachsend. Das ist nur bei der grünen Kurve der Fall.}
	}
	\lang{en}{
...
\begin{question}
	\lang{de}{
		...
		Mit Ihrer Maus k\"{o}nnen Sie den Ausschnitt und die Gr\"{o}{\ss}e des Bildes ver\"{a}ndern.}
		\explanation{Der Graph von $f'(x)$ entspricht offenbar dem Graph der Cosinus-Funktion. Damit muss $f(x) = \sin(x)$ sein.}
	}
	\lang{en}{
...
\begin{question}
	\lang{de}{
		\text{Gegeben sei der Graph von $f'(x)$. Welche der folgenden Funktionen kommt nur f\"{u}r $f$ in Frage?\\
		Mit Ihrer Maus k\"{o}nnen Sie den Ausschnitt und die Gr\"{o}{\ss}e des Bildes ver\"{a}ndern.}
		\explanation{Es ist $f(x) = e^x$, da für diese Funktion gilt $f'(x) = f(x)$.}
	}
	\lang{en}{
		\text{Given the graph of $f'(x)$, which of the following functions could be the function $f$?
	 	You can pan and zoom the graph using your mouse.}
