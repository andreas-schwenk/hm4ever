...
\begin{block}[annotation]
	Im Ticket-System: \href{https://team.mumie.net/issues/21361}{Ticket 21361}
\end{block}
\begin{block}[annotation]
Copy of \href{http://team.mumie.net/issues/9583}{Ticket 9583}: content/rwth/HM1/T111_Matrizen,_lineare_Gleichungssysteme/training/prb_problem6.src.tex
\end{block}

\usepackage{mumie.genericproblem}

\lang{de}{
	\title{A03: Lösungsmenge}
}
\lang{en}{
	\title{Problem 3}
}
...
\begin{problem}
	...
	\begin{question} %1. Frage 
        \lang{de}{\text{Welche Lösungsmengen sind für das folgende lineare Gleichungssystem korrekt?\\
        \begin{align*}
        ...
        \lang{de}{\explanation{Bringen Sie das lineare Gleichungssystem mit dem Gauß-Verfahren auf Stufenform, um zu erkennen, ob, wie viele und welche Variablen frei wählbar sind.\\
        Wenn Sie das wissen, können Sie die noch in Frage kommenden Auswahlmöglichkeiten durch Einsetzen überprüfen.}}
